...
public class HexGrid : MonoBehaviour
{
    ...
    float hexCellSize = HexMatrics.outerRadius;
    ...
    void CreateCell(int x, int z, int i)
    {
        ...
        position.y = 0f;
        position.z = (z - (float)height / 2) * hexCellSize * 1.5f;

        position.x = ((x - (float)width / 2) + z * 0.5f - z / 2) * (HexMatrics.innerRadius * 2f);
        ...
        cell.cellID = i;
        cell.name = "HexCell_" + cell.cellID;
