...
namespace ARETT.JSON
{
	...
	public class RecordingInfo
	{
		...
		public float transformRotX;
		public float transformRotY;
		public float transformRotZ;
		...
		public RecordingInfo(ARETT.RecordingInfo recordingInformation)
		{
			...
			transformPosX = recordingInformation.transformPosX;
			transformPosY = recordingInformation.transformPosY;
			transformPosZ = recordingInformation.transformPosZ;			
			
			transformRotX = recordingInformation.transformRotX;
			transformRotY = recordingInformation.transformRotY;
			transformRotZ = recordingInformation.transformRotZ;

			anchor = recordingInformation.anchor;
