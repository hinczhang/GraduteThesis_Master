...
public class ClippableObject : MonoBehaviour {
    public void OnEnable() {
        ...
        //GetComponent<LineRenderer>().sharedMaterial = new Material(Shader.Find("Custom/StandardClippable"))
        //{
        //    hideFlags = HideFlags.HideAndDontSave
        //};
    ...
    public void Start() {
        ...
        //GetComponent<LineRenderer>().sharedMaterial.shader = Shader.Find("Sprites/Default");
    }
    ...
    public void Update()
    {
        ...
        var sharedMaterial = GetComponent<LineRenderer>().sharedMaterial;
