...
public static class ColorUtility
{
    ...
    {
        // 添加颜色ID和RGBA值的映射关系
        colorById.Add(1, new Color(1f, 0f, 0f, 1f)); // 红色
        colorById.Add(2, new Color(0f, 1f, 0f, 1f)); // 绿色
        colorById.Add(3, new Color(0f, 0f, 1f, 1f)); // 蓝色
        colorById.Add(4, new Color(1f, 1f, 0f, 1f)); // 黄色
        colorById.Add(5, new Color(1f, 0f, 1f, 1f)); // 紫色
        colorById.Add(6, new Color(0f, 1f, 1f, 1f)); // 青色
        colorById.Add(7, new Color(0.5f, 0f, 0f, 1f)); // 深棕色
        colorById.Add(8, new Color(0.5f, 0f, 1f, 1f)); // 紫蓝色
        /*colorById.Add(7, new Color(0.5f, 0f, 0f, 1f)); // 深红色
        colorById.Add(8, new Color(0f, 0.5f, 0f, 1f)); // 深绿色
        colorById.Add(9, new Color(0f, 0f, 0.5f, 1f)); // 深蓝色
        colorById.Add(10, new Color(0.5f, 0.5f, 0f, 1f)); // 深黄色
        colorById.Add(11, new Color(0.5f, 0f, 0.5f, 1f)); // 深紫色
        colorById.Add(12, new Color(0f, 0.5f, 0.5f, 1f)); // 深青色
        colorById.Add(13, new Color(0.75f, 0.75f, 0.75f, 1f)); // 银色
        colorById.Add(14, new Color(0.5f, 0.5f, 0.5f, 1f)); // 灰色
        colorById.Add(15, new Color(1f, 0.65f, 0f, 1f)); // 橙色
        colorById.Add(16, new Color(0.5f, 0f, 0.25f, 1f)); // 褐色
        colorById.Add(17, new Color(1f, 1f, 1f, 1f)); // 白色
        colorById.Add(18, new Color(0f, 0f, 0f, 1f)); // 黑色
        colorById.Add(19, new Color(1f, 0.5f, 0f, 1f)); // 橙黄色
        colorById.Add(20, new Color(0.5f, 1f, 0f, 1f)); // 黄绿色
        colorById.Add(21, new Color(1f, 0f, 0.5f, 1f)); // 红紫色
        colorById.Add(22, new Color(0f, 1f, 0.5f, 1f)); // 绿青色
        
        colorById.Add(24, new Color(0f, 0.5f, 1f, 1f)); // 青蓝色
        colorById.Add(25, new Color(1f, 0.5f, 0.5f, 1f)); // 浅红色
        colorById.Add(26, new Color(0.5f, 1f, 0.5f, 1f)); // 浅绿色
        colorById.Add(27, new Color(0.5f, 0.5f, 1f, 1f)); // 浅蓝色
        colorById.Add(28, new Color(1f, 1f, 0.5f, 1f)); // 浅黄色
        colorById.Add(29, new Color(1f, 0.5f, 1f, 1f)); // 浅紫色
        colorById.Add(30, new Color(0.5f, 1f, 1f, 1f)); // 浅青色
        colorById.Add(31, new Color(0.5f, 0.5f, 0.25f, 1f)); // 暗黄色
        colorById.Add(32, new Color(0.5f, 0.25f, 0.5f, 1f)); // 暗紫色
        colorById.Add(33, new Color(0.25f, 0.5f, 0.5f, 1f)); // 暗青色
        colorById.Add(34, new Color(0.5f, 0f, 0f, 1f)); // 深棕色*/
