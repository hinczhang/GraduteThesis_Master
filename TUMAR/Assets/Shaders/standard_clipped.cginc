...
struct VertexOutputForwardClipBase
{
	...
	float4 tangentToWorldAndParallax[3]	: TEXCOORD2;	// [3x3:tangentToWorld | 1x3:viewDirForParallax]
...
float4 fragForwardClipBaseInternal (VertexOutputForwardClipBase i)
{
...
float4 fragForwardClipAddInternal(VertexOutputForwardClipAdd i)
{
