...
namespace ARETT {
	...
	public class DataLogger : MonoBehaviour
	{
		...
		private IEnumerator StartRecordingCoroutine()
		{
			...
			// Get Mesh Transform information
			Transform transform_Mesh = GameObject.Find("Mesh").transform;
			...
			lock (CurrentRecording)
			{
				...
				CurrentRecording = new RecordingInfo
				{
					...
					transformPosX = transform_Mesh.position.x,
					transformPosY = transform_Mesh.position.y,
					transformPosZ = transform_Mesh.position.z,
					transformRotX = transform_Mesh.rotation.eulerAngles.x,
					transformRotY = transform_Mesh.rotation.eulerAngles.y,
					transformRotZ = transform_Mesh.rotation.eulerAngles.z, 
					anchor = transform_Mesh.GetComponent<MeshAnchor>().anchorID
			};
