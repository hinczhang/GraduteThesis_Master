...
testData$Group[testData$Group == 'test'] <- 'Experimental'
...
ggexport(p_boxplot_LData, filename = 'D:\\Box_TLX_Learning.png',
...
p_boxplot_RData <- ggboxplot(
  ...
  xlab = 'Drawing Map Section', ylab = 'Evaluation Value', lab.size = 8, 
  width = 0.5, size = 0.8,
  outlier.shape = NA,
  add="mean",
  #facet.by = 'Task', nrow = 2,
...
ggexport(p_boxplot_RData, filename = 'D:\\Box_TLX_Recalling.png',
...
ggexport(p_boxplot_dist, filename = 'D:\\Box_TLX.png',
